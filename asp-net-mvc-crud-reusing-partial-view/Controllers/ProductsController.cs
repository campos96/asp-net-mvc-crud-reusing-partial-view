...
namespace asp_net_mvc_crud_reusing_partial_view.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,SupplierID,Name,Price,IsDiscontinued")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,SupplierID,Name,Price,IsDiscontinued")] Product product)
        {
            if (ModelState.IsValid)
            {
